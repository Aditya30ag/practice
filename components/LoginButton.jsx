  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50 p-6">
      <div className="max-w-md w-full space-y-8">
        ...
        {/* Main Card */}
        <div className="bg-white shadow-2xl rounded-2xl p-8 space-y-6 border border-gray-100 backdrop-blur-lg backdrop-filter">
          {/* Error Alert */}
          {error && (
            <div className="bg-red-50 text-red-800 rounded-lg p-4 text-sm animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="your@bennett.edu.in"
                />
              </div>
              <div>
            ...
            <button
              ...
              type="button"
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out"
            >
